...
kiwibot:
	...
	#         my office machine, but it won't throw errors if those directories don't
        #	  exist ;)
	g++ --output kiwibot -L/u1/pg/jp95/software/lua-5.1.5/lib -I/u1/pg/jp95/software/lua-5.1.5/include  main.cpp lua-interface.cpp system-utils.cpp ircbot.cpp timer.cpp -llua -ldl
